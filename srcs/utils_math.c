...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/03/24 17:27:06 by ahirzall          #+#    #+#             */
/*   Updated: 2025/03/24 17:27:07 by ahirzall         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 */
double	map_pixel_to_complex_plane(int pixel, int max_pixel, double min_val,
		double max_val)
{
